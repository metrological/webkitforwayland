...
public:
    ...
    static String createUninitialized(unsigned length, char16_t*& data) { return StringImpl::createUninitialized(length, data); }
    static String createUninitialized(unsigned length, Latin1Character*& data) { return StringImpl::createUninitialized(length, data); }
