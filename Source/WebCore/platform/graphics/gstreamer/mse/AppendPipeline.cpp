...
std::tuple<GRefPtr<GstCaps>, AppendPipeline::StreamType, FloatSize> AppendPipeline::parseDemuxerSrcPadCaps(GstCaps* demuxerSrcPadCaps)
{
    ...
    auto shouldIgnore = std::find_if(s_ignoreMediaTypes.begin(), s_ignoreMediaTypes.end(), [&originalMediaType](const ASCIILiteral& type) {
        return startsWithLettersIgnoringASCIICase(originalMediaType.span(), type);
...
static ASCIILiteral serialize(AppendPipeline::StreamType streamType)
{
    switch (streamType) {
    case AppendPipeline::StreamType::Audio:
        return "Audio"_s;
    case AppendPipeline::StreamType::Video:
        return "Video"_s;
    case AppendPipeline::StreamType::Text:
        return "Text"_s;
    case AppendPipeline::StreamType::Invalid:
        return "Invalid"_s;
    case AppendPipeline::StreamType::Unknown:
        return "Unknown"_s;
    default:
